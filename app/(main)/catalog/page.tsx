...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.xeh.ro/catalog',
    images: [{
      url: 'https://www.xeh.ro/api/og?title=Catalog Echipamente HoReCa&subtitle=Peste 2600 produse profesionale de la RM Gastro și REDFOX&type=category',
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    images: ['https://www.xeh.ro/api/og?title=Catalog Echipamente HoReCa&type=category'],
  },
  alternates: {
    canonical: 'https://www.xeh.ro/catalog',
  },
}
