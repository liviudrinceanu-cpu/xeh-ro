...
export const metadata: Metadata = {
  title: 'Contact - XEH.ro',
  description: 'Contactează XEH.ro pentru echipamente HoReCa profesionale. Telefon, email, formular de contact și locație. Suntem aici să te ajutăm!',
  openGraph: {
    title: 'Contact | XEH.ro',
    description: 'Contactează-ne pentru echipamente HoReCa profesionale.',
  },
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="section-title">Contactează-ne</h1>
        <p className="section-subtitle mx-auto">
          Suntem aici să te ajutăm. Alege metoda de contact preferată sau completează formularul de mai jos.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          <h2 className="text-2xl font-bold text-primary mb-6">Trimite-ne un Mesaj</h2>
          <ContactForm />
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-200 rounded-2xl h-80 flex items-center justify-center">
            <div className="text-center text-gray-500">
              ...
              <p className="text-sm">(Se va adăuga integrarea)</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-primary">09:00 - 14:00</span>
              </div>
              <div className="flex justify-between">
