...
const articles = [
  {
    slug: 'top-15-frigidere-industriale-2026',
  ...
  {
    slug: 'cum-alegi-cuptor-profesional-perfect',
  ...
  {
    slug: 'cost-echipare-restaurant-complet-2026',
  ...
  {
    slug: 'blast-chiller-vs-congelator-diferente',
  ...
  {
    slug: 'echipamente-pizzerie-completa-ghid',
  ...
  {
    slug: 'mobilier-inox-ghid-complet',
